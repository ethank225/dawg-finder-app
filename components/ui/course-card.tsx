                    ...
                    <>
                      ...
                      <TooltipProvider>
                        <Tooltip>
                          ...
                          <TooltipContent>
                            <p>
                              {courseData.Rating?.toFixed(1)} out of 5 stars
                            </p>
                          </TooltipContent>
                        </Tooltip>
                      </TooltipProvider>
                  ...
                  {courseData.Difficulty > 0 ? (
                    <>
                      <div className="flex items-center justify-between mb-2">
                        ...
                        <span className="font-bold">
                          {courseData.Difficulty?.toFixed(1)}/5
                        </span>
                      </div>
                      <TooltipProvider>
                        <Tooltip>
                          ...
                          <TooltipContent>
                            <p>
                              {courseData.Difficulty?.toFixed(1)} out of 5
                              difficulty
                            </p>
                          </TooltipContent>
                        </Tooltip>
              ...
              <div className="space-y-3 mt-4 pt-3 border-t">
                ...
                <div className="text-sm">
                  ...
                  <div className="w-full bg-muted rounded-full h-2.5 mt-1">
                    <div
                      className="back-primary h-2.5 rounded-full"
                      style={{
                        width: `${
